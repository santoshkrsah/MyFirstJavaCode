...
public class BitwiseOperators2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(a << 2); // left-shift operator moves the value to the left side

		System.out.println(b >> 3); // right-shift operator moves the value to // the right side
		...
		// Logical OR (11) does not check second condition if first is true
		// Bitwise OR (1) always checks both conditions even if first condition
		// is true or false
